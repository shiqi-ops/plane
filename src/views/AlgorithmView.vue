...
const attackGroups = {
  ...
  proprietary: {
    ...
    list: [
      {
        name: 'DiffuseHide',
        principle: '面向无人机视觉模型的隐空间渐进式对抗攻击框架',
        detail_principle: '基于扩散模型，通过隐空间映射、前向扩散加噪、约束化渐进扰动注入与反向解码重建，生成高隐蔽性对抗样本',
        features: '扰动隐蔽性强、对抗效果可控，可有效突破像素空间检测，为无人机视觉模型提供安全、高效的鲁棒性测试',
        effect: '隐空间约束化扰动，在保证人眼不可察觉的前提下，实现对目标模型的有效欺骗'
      }
    ]
  }
}
